      ...
      <el-row>
        ...
        <el-form-item class="input" v-if="type!='info'"  label="下单编号" prop="xiadanbianhao">
          <el-input v-model="ruleForm.xiadanbianhao" 
              placeholder="下单编号" clearable  :readonly="ro.xiadanbianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="下单编号" prop="xiadanbianhao">
              <el-input v-model="ruleForm.xiadanbianhao" 
                placeholder="下单编号" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="业务名称" prop="yewumingcheng">
          <el-input v-model="ruleForm.yewumingcheng" 
              placeholder="业务名称" clearable  :readonly="ro.yewumingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="业务名称" prop="yewumingcheng">
              <el-input v-model="ruleForm.yewumingcheng" 
                placeholder="业务名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="业务类型" prop="yewuleixing">
          <el-input v-model="ruleForm.yewuleixing" 
              placeholder="业务类型" clearable  :readonly="ro.yewuleixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="业务类型" prop="yewuleixing">
              <el-input v-model="ruleForm.yewuleixing" 
          ...
          <el-form-item class="input" label="上门地址" prop="shangmendizhi">
              <el-input v-model="ruleForm.shangmendizhi" 
                placeholder="上门地址" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="接单员账号" prop="jiedanyuanzhanghao">
          <el-input v-model="ruleForm.jiedanyuanzhanghao" 
              placeholder="接单员账号" clearable  :readonly="ro.jiedanyuanzhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="接单员账号" prop="jiedanyuanzhanghao">
              <el-input v-model="ruleForm.jiedanyuanzhanghao" 
                placeholder="接单员账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="接单员姓名" prop="jiedanyuanxingming">
          <el-input v-model="ruleForm.jiedanyuanxingming" 
              placeholder="接单员姓名" clearable  :readonly="ro.jiedanyuanxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="接单员姓名" prop="jiedanyuanxingming">
              <el-input v-model="ruleForm.jiedanyuanxingming" 
                placeholder="接单员姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="接单员手机" prop="jiedanyuanshouji">
          <el-input v-model="ruleForm.jiedanyuanshouji" 
              placeholder="接单员手机" clearable  :readonly="ro.jiedanyuanshouji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="接单员手机" prop="jiedanyuanshouji">
              <el-input v-model="ruleForm.jiedanyuanshouji" 
                placeholder="接单员手机" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  data() {
	...
	yonghushouji : false,
	shangmendizhi : false,
	jiedanyuanzhanghao : false,
	jiedanyuanxingming : false,
	jiedanyuanshouji : false,
	jiedanshijian : false,
	zhuangtai : false,
      },
            ruleForm: {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shangmendizhi = true;
            continue;
	            	            ...
	            	            if(o=='jiedanyuanzhanghao'){
            this.ruleForm.jiedanyuanzhanghao = obj[o];
	    this.ro.jiedanyuanzhanghao = true;
            continue;
          }
	            	            if(o=='jiedanyuanxingming'){
            this.ruleForm.jiedanyuanxingming = obj[o];
	    this.ro.jiedanyuanxingming = true;
            continue;
          }
	            	            if(o=='jiedanyuanshouji'){
            this.ruleForm.jiedanyuanshouji = obj[o];
	    this.ro.jiedanyuanshouji = true;
            continue;
          }
	            	            if(o=='jiedanshijian'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
                                                                                                                                                                                                                            		if(json.jiedanyuanzhanghao!=''&&json.jiedanyuanzhanghao){
              		this.ruleForm.jiedanyuanzhanghao = json.jiedanyuanzhanghao
		}
                                  		if(json.jiedanyuanxingming!=''&&json.jiedanyuanxingming){
              		this.ruleForm.jiedanyuanxingming = json.jiedanyuanxingming
		}
                                  		if(json.jiedanyuanshouji!=''&&json.jiedanyuanshouji){
              		this.ruleForm.jiedanyuanshouji = json.jiedanyuanshouji
		}
                                                                          } else {
