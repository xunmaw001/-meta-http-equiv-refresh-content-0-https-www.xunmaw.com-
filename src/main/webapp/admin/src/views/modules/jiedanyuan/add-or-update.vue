...
export default {
            ...
            ruleForm: {
                	        jiedanyuanzhanghao: '',
	                        	        ...
	                        	        jiedanyuanshouji: '',
                                                              ...
                                                              rules: {
                  jiedanyuanzhanghao: [
                            { required: true, message: '接单员账号不能为空', trigger: 'blur' },
                                    	                                                              ],
                  mima: [
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `jiedanyuan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jiedanyuanCrossAddOrUpdateFlag = false;
                  this.parent.search();
