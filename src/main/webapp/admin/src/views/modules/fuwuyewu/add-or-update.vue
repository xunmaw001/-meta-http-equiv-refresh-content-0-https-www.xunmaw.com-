          ...
          <el-form-item class="input" label="业务名称" prop="yewumingcheng">
              <el-input v-model="ruleForm.yewumingcheng" 
                placeholder="业务名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="业务类型" prop="yewuleixing">
          <el-select v-model="ruleForm.yewuleixing" placeholder="请选择业务类型">
            <el-option
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.fengmiantupian" label="封面图片" prop="fengmiantupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.fengmiantupian.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="承接时间" prop="chengjieshijian">
          <el-input v-model="ruleForm.chengjieshijian" 
              placeholder="承接时间" clearable  :readonly="ro.chengjieshijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="承接时间" prop="chengjieshijian">
              <el-input v-model="ruleForm.chengjieshijian" 
                placeholder="承接时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                  <el-col :span="12">
          ...
          <el-form-item class="input" label="价格" prop="jiage">
              <el-input v-model="ruleForm.jiage" 
                placeholder="价格" readonly></el-input>
                                                                                ...
                                                                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="业务详情" prop="yewuxiangqing">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.yewuxiangqing" label="业务详情" prop="yewuxiangqing">
                    <span>{{ruleForm.yewuxiangqing}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fengmiantupian = true;
            continue;
	            	            ...
	            	            if(o=='chengjieshijian'){
            this.ruleForm.chengjieshijian = obj[o];
	    this.ro.chengjieshijian = true;
            continue;
          }
	            	            if(o=='yewuxiangqing'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `fuwuyewu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.fuwuyewuCrossAddOrUpdateFlag = false;
                  this.parent.search();
