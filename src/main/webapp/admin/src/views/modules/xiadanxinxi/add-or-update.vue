...
export default {
  ...
  methods: {
        ...
        if (data && data.code === 0) {
          var json = data.data;
              		...
              		this.ruleForm.yonghushouji = json.yonghushouji
                                  		...
                                  		if(json.shangmendizhi!=''&&json.shangmendizhi){
              		this.ruleForm.shangmendizhi = json.shangmendizhi
		}
                                                                                                                                            } else {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `xiadanxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xiadanxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
