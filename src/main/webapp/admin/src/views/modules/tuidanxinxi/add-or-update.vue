<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="退单编号" prop="tuidanbianhao">
            <el-input v-model="ruleForm.tuidanbianhao" 
                placeholder="退单编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.tuidanbianhao" label="退单编号" prop="tuidanbianhao">
              <el-input v-model="ruleForm.tuidanbianhao" 
                placeholder="退单编号" readonly></el-input>
          </el-form-item>
        </div>
          ...
          <el-form-item class="input" v-if="ruleForm.tuidanshijian" label="退单时间" prop="tuidanshijian">
              <el-input v-model="ruleForm.tuidanshijian" 
                placeholder="退单时间" readonly></el-input>
                                                                                                                                                      ...
                                                                                                                                                      <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="退单理由" prop="tuidanliyou">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="退单理由"
                  v-model="ruleForm.tuidanliyou" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.tuidanliyou" label="退单理由" prop="tuidanliyou">
                    <span>{{ruleForm.tuidanliyou}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='tuidanbianhao'){
            this.ruleForm.tuidanbianhao = obj[o];
	    this.ro.tuidanbianhao = true;
            continue;
          }
	            	            if(o=='xiadanbianhao'){
	    ...
	    this.ro.tuidanshijian = true;
            continue;
	            	            ...
	            	            if(o=='tuidanliyou'){
            this.ruleForm.tuidanliyou = obj[o];
	    this.ro.tuidanliyou = true;
            continue;
          }
	            	            	                    }
                                                                                                                                                                                                              }
